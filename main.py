...
from social_networks_handlers.telegram import send_telegram_post
...
def main():
    ...
    while True:
        ...
        for post_number, post in enumerate(all_posts, start=2):
            ...
            if formatted_datetime <= datetime_now and post['public_fact'] != 'TRUE':
                send_telegram_post(telegram_bot_token, telegram_chat_id, post)
                sheet_functions.post_cell_text(post_number, 7, 'TRUE')
